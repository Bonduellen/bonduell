...
async def start(message: Message) -> None:
    await message.answer(
        ...
        "Я бот який показує точну погоду в містах Бельгії.",
    )
...
async def get_weather(call: CallbackQuery, callback_data: WeatherCallback) -> None:
    ...
    if response.status_code == 200:
        ...
        await call.message.answer("❌ Не вдалося отримати погоду. Перевірте назву міста!")
